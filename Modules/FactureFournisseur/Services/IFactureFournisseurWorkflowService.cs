...
public interface IFactureFournisseurWorkflowService
{
    ...
    Task UpdatePaiementAsync(int factureFournisseurId, int paiementId, decimal montant, DateTime date, GestionCommerciale.Modules.Facturation.Models.ModePaiement mode, string reference, bool estEncaisse, CancellationToken cancellationToken = default);
